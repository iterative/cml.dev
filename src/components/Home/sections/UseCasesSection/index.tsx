...
const UseCasesSection: React.ForwardRefRenderFunction<HTMLElement> = (
  ...
  <section>
    ...
    <ExampleBox title="CML Report">
      <a target="_blank" href="https://gitlab.com/iterative.ai/cml-base-case/-/merge_requests/3" alt="GitLab Base report example">
        <Image src="/img/gitlab/base-case-report.png" />
      </a>
    </ExampleBox>
    ...
    <ExampleBox title="CML Report">
      <a target="_blank" href="https://github.com/iterative/cml_base_case/pull/2" alt="Github Base report example">
        <Image src="/img/github/base-case-report.png" />
      </a>
    ...
    <ExampleBox title="CML Report">
      <a target="_blank" href="https://gitlab.com/iterative.ai/cml-dvc-case/-/merge_requests/6" alt="GitLab DVC report example">
        <Image src="/img/gitlab/dvc-report.png" />
      </a>
    ...
    <ExampleBox title="CML Report">
      <a target="_blank" href="https://github.com/iterative/cml_dvc_case/pull/4" alt="GitHub DVC report example">
        <Image src="/img/github/dvc-report.png" />
      </a>
    ...
    <Collapser>
      ...
      <ExampleBox title="CML Report">
        <a target="_blank" href="https://gitlab.com/iterative.ai/cml-tensorboard-case/-/merge_requests/2" alt="GitLab Tensorboard report example">
          <Image src="/img/gitlab/tensorboard-report.png" />
        </a>
    ...
    <Collapser>
      ...
      <ExampleBox title="CML Report">
        <a target="_blank" href="https://github.com/iterative/cml_tensorboard_case/pull/1" alt="GitHub Tensorboard report example">
          <Image src="/img/github/tensorboard-report.png" />
        </a>
    ...
    <Collapser>
      ...
      <ExampleBox title="CML Report">
        <a target="_blank" href="https://gitlab.com/iterative.ai/cml-runner-example/-/merge_requests/2" alt="GitLab Cloud report example">
          <Image src="/img/gitlab/cml-runner-report.png" />
        </a>
    ...
    <Collapser>
      ...
      <ExampleBox title="CML Report">
        <a target="_blank" href="https://github.com/iterative/cml-runner-base-case/pull/4" alt="GitHub Cloud report example">
          <Image src="/img/github/cml-runner-report.png" />
        </a>
    ...
    <Collapser>
      ...
      <ExampleBox title="CML Report">
        <a target="_blank" href="https://gitlab.com/iterative.ai/cml-cloud-case/-/merge_requests/1" alt="GitLab Cloud report example">
          <Image src="/img/gitlab/cloud-report.png" />
        </a>
    ...
    <Collapser>
      ...
      <ExampleBox title="CML Report">
        <a target="_blank" href="https://github.com/iterative/cml_cloud_case/pull/11" alt="GitHub Cloud report example">
          <Image src="/img/github/cloud-report.png" />
        </a>
