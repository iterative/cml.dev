...
![GitLab Base report example](../src/media/gitlab/base-case-report.png)
...
![GitHub Base report example](../src/media/github/base-case-report.png)
...
![GitLab DVC report example](../src/media/gitlab/dvc-report.png)
...
![GitHub DVC report example](../src/media/github/dvc-report.png)
...
![GitLab Tensorboard report example](../src/media/gitlab/tensorboard-report.png)
...
![GitHub Tensorboard report example](../src/media/github/tensorboard-report.png)
...
![GitLab Cloud report example](../src/media/gitlab/cloud-report.png)
...
![GitHub Cloud report example](../src/media/github/cloud-report.png)
