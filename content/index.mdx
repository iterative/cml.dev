...
<FullWidthBox sx={{
  ...
  <Collapser sx={{
    ...
    <Box sx={{flex: "1", textAlign: ["center", "left"], mr: [0, "60px"]}}>
      <Heading as="h1" sx={{my: 4, mx: 2}}>
    ...
    <Box sx={{flex: "1"}}>
      <Switch sx={{ mt: 4, mx: "auto", maxWidth: ["100%", "160px"] }} />
      <Switchable
  ...
  <Collapser>
  <HomeFeature heading="GitFlow for data science" circleColor="cyan.0">
...
your Git repo.
  ...
  <HomeFeature heading="Auto reports for ML experiments" circleColor="purple">
...
decisions.
  ...
  <HomeFeature heading="No additional services" circleColor="orange.0">
...
<Box variant="text.translucent.dark" sx={{mx: 3, maxWidth: "615px"}}>
...
```yml filename="cml.yaml" repo="https://github.com/iterative/cml_base_case" sx={{flex: "1"}}
name: train-my-model
...
```yml filename=".gitlab-ci.yml" repo="https://gitlab.com/iterative.ai/cml-base-case" sx={{flex: "1"}}
# .gitlab-ci.yml
stages: 
    - cml_run
...
```yml filename="cml.yaml" repo="https://github.com/iterative/cml_dvc_case" sx={{flex: "1"}}
name: train-my-model
...
```yml filename=".gitlab-ci.yml" repo="https://gitlab.com/iterative.ai/cml-dvc-case" sx={{flex: "1"}}
stages: 
    - cml_run
...
```yml filename="cml.yaml" repo="https://github.com/iterative/cml_tensorboard_case" sx={{flex: "1"}}
name: train-my-model
...
```yml filename=".gitlab-ci.yml" repo="https://gitlab.com/iterative.ai/cml-tensorboard-case" sx={{flex: "1"}}
stages: 
    - cml_run
